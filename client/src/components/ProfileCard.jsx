...
const ProfileCard = () => {
  ...
  const { role, last_name, first_name, email, profile_photo, telegram, phone_number} = storedUserData;
  ...
  return (
    <StyledProfileCard>
      <Avatar
        ...
        sx={{ width: 170, height: 170, bgcolor: "#0d417d", color: "white", border: '1px solid white' }}
        />
      <StyledProfileWrapper>
        ...
        <Button sx={{width:"100%", mt:2}}  onClick={handleLogout} variant="contained">Выйти</Button>
      </StyledProfileWrapper>
    </StyledProfileCard>
  );
};
